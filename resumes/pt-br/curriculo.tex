...
\begin{center}
    ...
    Limeira, São Paulo
    {\textbullet}
    \href{mailto:seu.email@exemplo.com}{nogueiragabriela361@gmail.com} 
    {\textbullet}
    \href{https://linkedin.com/in/usuario}{www.linkedin.com/in/gabriela-nogueira-5a04a5351} 
    {\textbullet}
    \href{https://github.com/usuario}{github.com/GabrielaNogueira2}
\end{center}
...
\section{Habilidades}
    ...
    \begin{itemize}
        ...
        \item{\textbf{Conhecimentos:}Visualização de Dados, Machine Learning (Básico), Agentes de IA (LLMs)}
